...
?></span>
	<h2>We work with many areas of activity so we integrate our sites with many systems</h2>

	<h3>CMS</h3>
	<div class="row"> 
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Wordpress<br><img src="Wordpress.png"></div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Joomla<br><img src="Joomla.png"></div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Drupal<br><img src="Drupal.png"></div>
	</div>

	<div class="row">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Magento<br><img src="Magento.png"></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Opencart<br><img src="Opencart.png"></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Bitrix<br><img src="Bitrix.png"></div>
	</div>
	...
	<div class="row">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">MasterCard<br><img src="MasterCard.png"></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">VISA<br><img src="VISa.png"></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">American Express<br><img src="American Express.png"></div>
	</div>
	<div class="row">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">PayPal<br><img src=PayPal.png></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Webmoney <br><img src="Webmoney .jpg"></div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Payeer<br><img src="Payeer.png"></div>
	</div>
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Meest express<br><img src="Meest express.jpg"></div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">In time<br><img src="in time.png"></div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">New Post<br><img src="NewPost.png"></div>
	</div>
...
<div class="container">
	<footer  id="footer" class="footer footer-fixed-bottom">
		&copy Developed by Bohdan Zahoruiko<br>
	</footer>
</div>
